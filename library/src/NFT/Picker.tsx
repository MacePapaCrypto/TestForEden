                    ...
                    <Box p={ 2 }>
                      <Stack spacing={ 2 }>
                        ...
                        { getContracts().map((contract) => {
                          // return jsx
                          return (
                            <Box key={ `contract-${contract.id}` } sx={ {
                              ...
                              <Grid container spacing={ 1 }>
                                { getImages(contract.id).map((image, i) => {
                                  // return image
                                  return (
                                    <Grid item xs={ 3 } key={ `image-${contract.id}-${image.id || i}` }>
                                      <NFTImage
                                        item={ image }
                                        width={ NFTWidth }
                                        height={ NFTWidth }
