...
const MoonAppSpaceSideBarSub = (props = {}) => {
  // ref
  ...
  // return jsx
  return (
    <MenuItem ref={ props.can('subspace:create') ? ref : undefined } selected={ props.active } onClick={ () => onSelect(item) } sx={ {
...
// export default
export default MoonAppSpaceSideBarSub;