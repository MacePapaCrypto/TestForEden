  ...
  return (
    ...
    >
      <ClickAwayListener onClickAway={ () => setActive(false) }>
        <Tooltip title="Test Icon">
          <Box sx={ {
            flex          : 1,
            width         : shortcutSize,
            height        : shortcutSize,
            cursor        : 'pointer',
            border        : active ? `.1rem solid ${theme.palette.grey[300]}` : `.1rem solid rgba(255, 255, 255, 0)`,
            display       : 'flex',
            ...
            '&:hover' : {
              border     : active ? `.1rem solid ${theme.palette.grey[300]}` : `.1rem solid rgba(255, 255, 255, 0.25)`,
