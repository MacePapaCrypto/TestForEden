...
// locals
import { Button, NFTAvatar, useDesktop } from '@moonup/ui';

// create item
const AppSpaceItem = (props = {}) => {
  // theme
  ...
  // active
  const active = desktop.tasks.find((t) => t.app === props.app?.id && t.path.startsWith(`/space/${props.item.id}`));
  ...
  return (
    <Paper sx={ {
      ...
      <Stack direction="column" spacing={ 1 }>
        ...
        <Button loading={ opening } variant={ props.item?.member ? undefined : 'contained' }>
