...
// use local
import { useAcls, useMember, useDesktop } from '@moonup/ui';

// import
import SideBarSub from './SideBar/Sub';

// sub spaces
const AppSpaceSideBar = (props = {}) => {
  // theme
  ...
  const onCreateSubSpace = async () => {
    ...
    await desktop.findOrCreateTask({
      app  : props.app?.id,
      path : `/space/${props.space?.id}/create`,
    });
    ...
    <>
      ...
      <DndProvider backend={ HTML5Backend }>
        <MenuList sx={ {
          ...
          { (props.loading || props.subSpaces?.loading === 'list') && (
            <Stack sx={ {
              mb : 1,
              mt : 1.5,
            } } spacing={ .5 }>
...
// export default
export default AppSpaceSideBar;